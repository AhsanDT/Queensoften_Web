        ...
        <div class="userDropDown">
            ...
            <div class="userSidebar">
                ...
                <div class="profileEidt">
                    ...
                    <form class="eidtForm ajax-form" enctype="multipart/form-data" method="POST" data-action="{{route('profile.update',['id'=>auth('admin')->user()->id])}}" autocomplete="off">
                        @csrf()
                        <div class="UserImg">
                            ...
                            <div class="avatar-preview">
                                <div id="imagePreview" style="background-image: url({{auth('admin')->user()->picture}});">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="text" name="email" class="form-control" value="{{auth('admin')->user()->email}}" autocomplete="off">
                        </div>
                        <div class="form-group">
