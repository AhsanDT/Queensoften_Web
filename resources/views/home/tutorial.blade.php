...
<main>
    ...
    <div class="sec-banner play_queen tutorial">
    <h2>How to play<span style="color:#531083;"> queens of 10!</span>
        </div>
            ...
            <div class="product_card row">
                <div class="col-md-3 mb-3 ">
                    <div class="section card_contant counter">
                        ...
                        <div class="imag_box">
                            <img src="{{asset('home/images/queencard7.png')}}" alt="img">
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <div class="section card_contant counter">
                        <div class="box-contant">
                            <p>When a move is valid, the game will automatically draw two (2) cards on the deck and put
                                them on top of the card that was selected (Hard Mode). </p>
                            <p>In the Easy and Medium difficulty. The card that is selected in the field will be
                                replaced by the card selected on the corresponding deck (left or right). Same rules
                                apply.</p>
                        </div>
                        <div class="imag_box">
                            <img src="{{asset('home/images/queencard8.png')}}" alt="img">
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                ...
                <div class="col-md-3 mb-3">
                    <div class="section card_contant counter">
                        <div class="box-contant">
                            <p>If there are No two (2) cards on the field that sums up to ten (10) the player loses the
                                game. </p>
                        </div>
                        <div class="imag_box">
