...
<main>
    ...
    <section class="section play_queens">
        <div class="sec-banner  play_queen">
            <h2 data-aos="zoom-out">How to play<span class="text-warning"> queens of 10!</span></h2>
        </div>
        <div class="container-fluid">
            <div class="product_card product-card-slider row ">
                @foreach($tutorials->sortBy('sequence') as $tutorial)
                <div class="col-xl-3 col-md-6 col-sm-6 mb-3" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                    ...
                    <div class="section card_contant counter ">
                        ...
                        <div class="box-contant">
                            ...
                            {{-- <p>Easy and Medium - lets you play the game with easier and relax way. You have the
                                ability to skip a card.</p>--}}
                        </div>
                        <div class="imag_box">
                            <img src="https://queensoftenimages.s3.us-west-1.amazonaws.com/{{$tutorial->image}}"
                                alt="img">
                        </div>
                    </div>
                </div>
                    ...
                    <div class=" col-lg-4 col-md-4 col-sm-6" data-aos="flip-right" data-aos-easing="ease-out-cubic"
                        ...
                        <div class="section card_contant ">
                            ...
                            <div class="discribtion d-flex justify-content-between">
                                <p>{{$recentItem->name ?? $recentItem->origin}}</p>
                                <p>$100.00</p>
                            </div>
    ...
    <section class="sec-banner business_queen">
        <div class="container">
            <h2 data-aos="zoom-out">elevate YOUR BUSINESS WITH QUEENS OF TEN</h2>
            <div class="product_card row">
                <div class="col-xl-3 col-md-4 col-sm-6" data-aos="fade-right" data-aos-easing="ease-out-cubic"
                    data-aos-duration="1000">
                ...
                <div class="col-xl-3 col-md-4 col-sm-6" data-aos="fade-down-right" data-aos-easing="ease-out-cubic"
                    data-aos-duration="1000">
                ...
                <div class="col-xl-3 col-md-4 col-sm-6" data-aos="fade-down-left" data-aos-easing="ease-out-cubic"
                    data-aos-duration="1000">
                ...
                <div class="col-xl-3 col-md-4 col-sm-6" data-aos="fade-left" data-aos-easing="ease-out-cubic"
                    data-aos-duration="1000">
                    <a href="{{route('terms')}}">
                        <div class="section card_contant">
                            <div class="imag_box">
    ...
    <section>
        <div class="sec-banner m-0">
            <h2 data-aos="zoom-out"><span class="text-warning"> The Story</span> of queens of ten <br>
                and it’s beginning</h2>
        </div>
        <div class="story row">
            <div class="col-md-6" data-aos="fade-right" data-aos-easing="ease-out-cubic" data-aos-duration="1000">
                <div class="story-img">
                </div>
            </div>
            <div class="col-md-6 " data-aos="fade-left" data-aos-easing="ease-out-cubic" data-aos-duration="1000">
