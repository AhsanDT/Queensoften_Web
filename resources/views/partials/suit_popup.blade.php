    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form  method="POST" class="ajax-form" data-action="{{route('e-store.suit')}}">
                    @csrf
                    <div class="row">
                        <div class="form-group col-md-12 d-flex">
                            <div class="imgUpload mx-auto" style="max-width: 200px">
                                <label for='suitImgCoverPhoto'>
                                    <input type="file" class="imageInput" id='suitImgCoverPhoto' placeholder="Image upload" name="image" accept="image/*">
                            ...
                            <div class="imgUpload mx-auto" style="max-width: 200px">
                                <label for='mobileImgCoverPhoto2'>
                                    <input type="file" class="imageInput" id='mobileImgCoverPhoto2' placeholder="Image upload" name="mobile_image" accept="image/*">
                                    <div class="placeholderBox">
                                        <div class="iconBox"></div>
                                        Mobile Image
                                    </div>
