...
class AuthController extends Controller
{
    ...
    function test(){
        $notifications = SupportTicket::orderBy('id','DESC')->get();
        foreach($notifications as $notification){https://appscorridor.com/queens-of-ten-admin/support
           dump( changeTimeFormat($notification->created_at->diffForHumans()));
        }
    }
}
